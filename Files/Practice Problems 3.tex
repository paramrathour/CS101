\section{Practice Problems 3 - Functions}
\subsection{Calendar}
...
\clearpage
\subsection{Thue-Morse Sequence aka Fair Share Sequence}
...
\end{testcases}
Again, can you find better solution?\\[1em]
\textbf{Fun Video}\\
...
\begin{testcases}
	{Arbitrary number of testcases (each space separated)\quad Stop when input is negative}
