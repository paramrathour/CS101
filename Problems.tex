...
\title{Practice Problems\\[0.5em]\Large{CS 101 Autumn 2020}}
...
60\\
100
\item For $n$ numbers $k_1\ k_2\ \ldots \ k_n$, find $\max(\pi(i))$ for $i = 1,2,\ldots,k_1$ and corresponding $i$\\
...
\end{equation}
\textbf{Problem Statement:}\\
Take a natural number $k$ as input and calculate $\pi$ till $k$\textsuperscript{th} iteration using Equation (\ref{eq:epi})
