...
\end{note}
\textbf{Problem Statement:}\\
Calculate $\pi$ using first $k_i+1$ terms \footnote{i.e calculate $\pi$ till $\dfrac{k_i!}{(2k_i+1)!!}$} using Equation (\ref{eq:epi}) for $n$ different natural numbers $k_1,k_2,\ldots,k_n$.\\
