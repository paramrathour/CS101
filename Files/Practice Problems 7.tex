...
Implement a class which supports $+,-,/,*$ and $roots, exponentiation$ over rational numbers, surds, complex numbers with (rational numbers, surds, etc) and user variables. (you may include more operations such as $\log$ trig functions, and numbers like $\pi,e$)
