...
Straightforward implementation of given recursive definition in problems \ref{itm:af} \& \ref{itm:part} b)

For \ref{itm:gp}, \ref{itm:dn} \& \ref{itm:part} a) try to find a recursive definition using previous terms\\
...
\end{enumerate}
\subsection{Practice Problems 7}
