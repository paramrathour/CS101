...
\begin{enumerate}
\item \textbf{Currency sums}{\label{itm:cs}}
...
\end{testcases}
\item \textbf{QuickSort} is an efficient sorting algorithm.\\
...
\end{testcases}
\clearpage
\item \textbf{Dyck words}{\label{itm:dw}}\\
...
\end{testcases}
\item \textbf{Egyptian Fraction}{\label{itm:ef}}\\
