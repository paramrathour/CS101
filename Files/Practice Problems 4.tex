\section{Practice Problems 4 - Recursion}{\label{pp4}}
...
\end{itemize}
\subsection{Ackermann function}{\label{itm:af}}
...
\end{testcases}
\clearpage
\subsection{GridPaths}{\label{itm:gp}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{GridPaths.png}
...
\clearpage
\subsection{Delannoy Numbers}{\label{itm:dn}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\linewidth]{Delannoy3x3.pdf}
	\caption{DelannoyNumber(3,3) = 63}
	\label{fig:dela}
\end{figure}
\textbf{Problem Statement:}\\
...
%Can you find efficient solution?
\clearpage
\subsection{Partitions}{\label{itm:part}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{Partitions.png}
