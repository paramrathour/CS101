\section{Practice Problems 6 - Give me name for this}{\label{pp6}}
...
\begin{testcases}
    ...
    {1\\2\\4\\11\\41\\451\\4563\\73682\\6295435\\27984272287}
\end{testcases}
\subsection{QuickSort}{\label{itm:qs}}
...
Some examples for $n=3$: XXXYYY\quad XYXXYY\quad XYXYXY\quad XXYYXY\quad XXYXYY\\
\textbf{Problem Statement:}\\
Find number of possible Dyck words for a given $n$ modulo $10^9+7$. \href{https://www.geeksforgeeks.org/modulo-1097-1000000007/}{why this number?}\\
\begin{testcases}
{$n$ (number of testcases)\\$n$ space separated integers}
{Number of ways; don't forget to take modulo! (each result on a newline)}
{8\\1 2 3 5 10 20 100 1000}
{1\\2\\5\\42\\16796\\564120378\\558488487\\110961515}
\end{testcases}
